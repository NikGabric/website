defmodule WebsiteWeb.CoreComponents do
  ...
  def header(assigns) do
    ...
    <header class={[@actions != [] && "flex items-center justify-between gap-6", "pb-4"]}>
      <div>
        <h1 class="text-2xl text-primary leading-8">
          {render_slot(@inner_block)}
        </h1>
    ...
    <ul class="list">
      <li :for={item <- @item} class="list-row">
        <div class="list-col-grow">
          ...
          <div class="text-base-content/80">{render_slot(item)}</div>
        </div>
      </li>
    </ul>
    """
  ...
  The brand marks `brand-github` and `brand-linkedin` are rendered as inline
  SVG, since Heroicons does not ship logos.
  ...
  def icon(%{name: "brand-linkedin"} = assigns) do
    ~H"""
    <svg class={@class} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
